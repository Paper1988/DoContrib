	...
	return (
		<Toolbar.BlockSelector
			className={`w-32.5
                ...
                dark:hover:bg-white/10 hover:bg-gray-200/50
                ...
                [&_ul]:dark:bg-black/80 [&_ul]:bg-white/95
                ...
                [&_li:hover]:dark:bg-white/10 [&_li:hover]:bg-gray-100
                [&_li[data-active=true]]:dark:bg-blue-500/20 [&_li[data-active=true]]:text-blue-500
                rounded-[24px] border dark:border-white/10 dark:bg-black/60 backdrop-blur-3xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)]
            `}
